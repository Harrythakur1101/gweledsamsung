...
var init = function () {
	...
	$(document).ready(function () {
		...
		myPlanshr.open("GET", "https://glewedtv.com/index.php?api/getmovies_bycategory/" + categoryid, true);
		myPlanshr.send();
		...
		$(document).on("click", "div.scrollmenu a", function () {
			...
			var muviurl = category_list[currentId].movie_url;
		...
		document.addEventListener('keydown', function (e) {
			switch (e.keyCode) {
				...
				case 13: //OK button
					...
					var muviurl = category_list[crntId].movie_url;
